...
import cn.qingting.core.domain.interfaces.IEntityParentChildrenBean;
...
import cn.qingting.core.util.BeanUtils;
...
public class BaseDaoImpl implements IBaseDao {
    ...
    public <T extends BaseBean> List<KeyValueResult> finalKeyValueResults(
        ...
        // 遍历map拼装hql
        for (Map.Entry<String, String> el : fieldMap.entrySet()) {
